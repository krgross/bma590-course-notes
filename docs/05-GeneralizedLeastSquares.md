...
```
The `summary` doesn't provide the residual variances for each country directly. Instead, in the portion of the summary labeled "Variance function", we find the estimated ratio of the residual variance for each country to the residual variance for the reference country, Denmark.  Thus, for example, the residual variance for the Netherlands is $0.726$ times the residual variance for Denmark, and so on. 
...
<img src="05-GeneralizedLeastSquares_files/figure-html/unnamed-chunk-25-1.png" width="672" />
...
<img src="05-GeneralizedLeastSquares_files/figure-html/unnamed-chunk-28-3.png" width="672" />
