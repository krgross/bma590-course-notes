...
```
## Inference for Bugs model at "C:/Users/krgross/AppData/Local/Temp/RtmpGw4bZf/model6fdc4e91f6", fit using jags,
##  3 chains, each with 1e+05 iterations (first 50000 discarded), n.thin = 50
##  n.sims = 3000 iterations saved. Running time = 0.36 secs
