...
The temperature trend is estimated as an increase of `r round(fm2$lme$coefficients$fixed['Xtime'], 6)` $^\circ$F per day.  That equates to a trend of `r round(365.25 * fm2$lme$coefficients$fixed['Xtime'], 6)` $^\circ$F per year, or `r round(3652.5 * fm2$lme$coefficients$fixed['Xtime'], 6)` per decade.  Yikes!
